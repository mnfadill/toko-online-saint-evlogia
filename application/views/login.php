...
<head>
  ...
  <meta name="description" content="saint evlogia admin is super flexible, powerful, clean & modern responsive tailwind admin template with unlimited possibilities.">
  <meta name="keywords" content="admin template, Icewall Admin Template, dashboard template, flat admin template, responsive admin template, web app">
  <meta name="author" content="LEFT4CODE">
  <title><?= $title ?> | Saint Evlogia</title>
  <!-- BEGIN: CSS Assets-->
    ...
    <div class="block xl:grid grid-cols-2 gap-4">
      ...
      <div class="hidden xl:flex flex-col min-h-screen">
        <a href="" class="-intro-x flex items-center pt-5">
          ...
          <span class="text-white text-lg ml-3"> Saint Evlogia </span>
        </a>
        <div class="my-auto">
          <img alt="Midone - HTML Admin Template" class="-intro-x w-1/2 -mt-16" src="<?= site_url('asset') ?>/admin/dist/images/logo.png">
          <div class="-intro-x text-white font-medium text-2xl leading-tight mt-10">
            Enjoy a faster checkout experience
            <br>
            and manage all your personal information in 
            <br>
            your dedicated account.
          </div>
          <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400">Enjoy for shopping</div>
        </div>
      </div>
      <!-- END: Login Info -->
      <!-- BEGIN: Login Form -->
